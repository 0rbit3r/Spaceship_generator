...
public class Generator extends Thread {
    ...
    public void run(){
        ship = generateNewShip();

        UIHandler handler = new UIHandler(activity);
     ...
     */
    public Generator(MainActivity activity, Parameters params, int seed) {
        r = new Random(seed);
     ...
     * @param activity Activity that called the constructor (used to get the drawable files and to get access to elements on screen)
     */
    public Generator(MainActivity activity, Parameters params) {
...
//        genIcon = binding.loadingTextView;
//        seedButton = binding.seedShipButton;
//        randomButton = binding.newShipButton;
//        imgShip = binding.imgShip;
    ...
    public Bitmap generateNewShip() {
        ...
        upscale(parameters.getScaleFactor());
        return ship;
    }
